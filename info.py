...
Here you can search Graphics Materials in inline mode. Just press following buttons and start searching.
"""

SHARE_BUTTON_TEXT = 'Checkout {username} for searching graphics materials'
